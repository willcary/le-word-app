...
export default function Header() {
  ...
  const light = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={iconColor()} class="bi bi-sun" viewBox="0 0 16 16">
  ...
  const dark = <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill={iconColor()} class="bi bi-moon" viewBox="0 0 16 16">
